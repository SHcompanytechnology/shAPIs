...
class LimitOfLiquidityAndPlasticityGraph
{
    ...
    <header>
        ...
        <table class="tg-cabecalho" style="width: 100%;margin-bottom: 13px">
            ...
            <table class="tg">
                    <tr>
    <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 675px;">                            <div style="border: 1px solid #000; margin: 20px 0px 15px 0px; padding: 4px">
    <div style="width: 50%; margin-left: 35%; position: absolute; z-index: 1; top: 300px; height: 25px; font-size: 15px; background-color: #fff;">GRÁFICO DO LIMITE LIQUIDEZ</div>

    <img src="data:image/jpeg;base64,' . base64_encode($dataImagemLimitesAttemberg['Image']) . '" alt="Imagem" width="700px" height="510px">
                            </div>
                            <div class="tg-limit-of-liquidity-wrap">
                                <table class="tg-limit-of-liquidity" style="width: 79%; margin-left: 9%;">
                                    <colgroup>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="tg-limit-of-liquidity-ltad">Limite de liquidez</td>
                                            <td class="tg-limit-of-liquidity-6nwz" style="width: 40px">LL =</td>
                                            <td class="tg-limit-of-liquidity-6nwz" style="width: 70px">' . $dataLimitesAttemberg['LL'] . '</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tg-limit-of-liquidity-6nwz">' . $dataLimitesAttemberg['LP'] . '</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tg-limit-of-liquidity-6nwz">' . $dataLimitesAttemberg['IP'] . '</td>
                                            <td class="tg-limit-of-liquidity-6nwz">%</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-limit-of-liquidity-ltad">Índice de consistência</td>
                                            <td class="tg-limit-of-liquidity-6nwz">IC =</td>
                                            <td class="tg-limit-of-liquidity-6nwz">' . $dataLimitesAttemberg['IC'] . '</td>
                                            <td class="tg-limit-of-liquidity-6nwz">%</td>
                                        </tr>
                                    </tbody>
                                </table>
