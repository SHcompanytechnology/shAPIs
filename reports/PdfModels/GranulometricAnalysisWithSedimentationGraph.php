            ...
            <table class="tg">
                <tr>
                  <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important;">
                    <div style="border: 1px solid #000; margin: 30px 0px 50px 0px; padding: 5px 0px 5px 5px">
                    <div style="width: 84%; margin-left: 36%; position: absolute; z-index: 1; top: 340px">
                    ...
                    <div style="width: 84%; margin-left: 36%; position: absolute; z-index: 1; top: 775px">
                        <div style="display: inline-block; font-size: 8px; margin-right: 4px">
                          0,075
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 4px">
                          0,150
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 5px">
                          0,250
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 2px">
                          0,425
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 8px">
                          0,600
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 8px">
                          1,12
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 22px">
                          2,00
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 16px">
                          4,75
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 8px">
                          9,51
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 0px">
                          19,1
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 1px">
                          25,4
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 0px; font-family: DejaVu Sans !important">
                          38,1
                        </div>
                        <div style="display: inline-block; font-size: 8px; margin-right: 17px;">
                          50,8
                        </div>
                      </div>
                      <div style="width: 50%; margin-left: 30%; position: absolute; z-index: 1; top: 305px; height: 30px; font-size: 15px; background-color: #fff;">CURVA DE DISTRIBUIÇÃO GRANULOMÉTRICA</div>
                      <img src="data:image/jpeg;base64,' . base64_encode($graph) . '" alt="Imagem" width="700px" height="540px">

                      <div style="width: 84%; margin-left: 9%;">
                        <div style="display: inline-block; font-size: 10px; margin-right: 88px">
                          0.00
                        </div>
                        <div style="display: inline-block; font-size: 10px; margin-right: 85px">
                          0.01
                        </div>
                        <div style="display: inline-block; font-size: 10px; margin-right: 90px">
                          0.10
                        </div>
                        <div style="display: inline-block; font-size: 10px; margin-right: 80px">
                          1.00
                        </div>
                        <div style="display: inline-block; font-size: 10px; margin-right: 121px">
                          10.00
                        </div>
                      ...
                      <div>
                        <table class="tg-tabela-grafico" style="width: 79%; margin-left: 10%;">
                          <colgroup>
                          ...
                          <tbody>
                            <tr>
                              <td class="tg-tabela-grafico-0lax" style="width: 18px">Argila</td>
                              <td class="tg-tabela-grafico-0lax" style="text-align: center; width: 80px">Slite</td>
                              <td class="tg-tabela-grafico-0lax" style="text-align: center; width: 18px">Areia Fina</td>
                              <td class="tg-tabela-grafico-0lax" style="text-align: center; width: 22px">Areia Media</td>
                              <td class="tg-tabela-grafico-0lax" style="text-align: center; width: 18px">Areia Grossa</td>
                              <td class="tg-tabela-grafico-0lax" style="text-align: center; width: 126px">Pedregulho</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
